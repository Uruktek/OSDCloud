...
try {
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/uruktek/OSDCloud/main/unattend.xml -OutFile Out-File -FilePath 'C:\Windows\unattend.xml' -Encoding ascii -Force
