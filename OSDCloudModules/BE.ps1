...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/urukteks/OSDCloud/main/OSDCloudModules/Module.psm1" -OutFile "X:\Program Files\WindowsPowerShell\Modules\OSDCloudLogic\OSDCloudLogic.psm1"
